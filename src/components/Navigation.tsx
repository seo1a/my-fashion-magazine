  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-sm border-b border-white/10">
      <div className="mx-auto flex max-w-8xl items-center justify-between px-4 sm:px-8 md:px-16 lg:px-32 xl:px-56 py-3 sm:py-4 md:py-6 font-noto_sans text-myGreen">
        ...
        >
          <span
            className={`block w-6 h-0.5 bg-myGreen transition-all duration-300 ${
      ...
      <div
        className={`sm:hidden fixed top-0 right-0 h-full w-64 bg-black/20 backdrop-blur-md border-l border-white/10 transform transition-transform duration-300 ease-in-out z-40 ${
